      ...
      <div id="hero" className="home">
        <div className="container">
          <div className="hero-content">
            <h1>
              I'm <span className="typed" data-typed-items="Fayozbek Hamidov, Designer, Developer, Photographer"></span>
            </h1>
              ...
              <div className="col-lg-7">
                <div className="about-descr">
                  <p className="p-heading">
                    im a ux /ui designer austin based who loves clean, simple & unique design. i also enjoy crafting brand identities, icons, &
                    ilustration work.{" "}
                  </p>
                  <p className="separator">
                    ...
                    The European languages are members of the same family.English person.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="journal-info bg-hever">
                    <a href="https://singular-haupia-e3e855.netlify.app">
                      <img style={{ height: "312px" }} src="/src/img/my/so-list.jpg" className="img-responsive" alt="img" />
                    </a>

                    <div className="journal-txt">
                      <h4>
                        <a href="blog-single.html">SO LETS MAKE THE MOST IS BEAUTIFUL</a>
                      </h4>
                      <p className="separator">To an English person, it will seem like simplified English</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="journal-info bg-hever">
                    <a href="https://rococo-gelato-1eec4e.netlify.app">
                      <img src="/src/img/blog-post-3.jpg" className="img-responsive" alt="img" />
                    </a>
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="journal-info bg-hever">
                    <a href="https://github.com/Fayozbek-7073/new.">
                      <img src="/src/img/blog-post-2.jpg" className="img-responsive" alt="img" />
                    </a>

                    <div className="journal-txt">
                      <h4>
                        <a href="blog-single.html">NEW LIFE CIVILIZATIONS TO BOLDLY</a>
                      </h4>
                      <p className="separator">To an English person, it will seem like simplified English</p>
                    </div>
                  </div>
